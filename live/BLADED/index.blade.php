...
@section('seo-description') @endsection
@section('seo-author') @endsection

@section('per-page-styles')
...
@section('per-page-javascript')
<!-- start: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY --> 
<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
@endsection

@section('pagescript') @endsection
